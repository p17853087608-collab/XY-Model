...
class SpinConfigurationVisualizer:
    ...
    def generate_summary_report(self, root_dir: str) -> None:
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            f.write("Spin Configuration Visualization Summary Report v3.0 - 并行版本\n")
            f.write("=" * 50 + "\n")
...
def main():
    ...
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='自旋配置可视化脚本 v3.0 - 并行版本')
